...
export interface NodeDelayedPositionProps {
 ...
 * Tests the grid size
 */
class NodeDelayedPosition extends React.Component<NodeDelayedPositionProps> {
  constructor(props: NodeDelayedPositionProps) {
    super(props);
